...
export default function About() {
  return (
    <>
    <Navbar />
    <div className="min-h-screen flex flex-col items-center px-6 py-16 bg-white text-gray-800">
      <h1 className="text-4xl font-bold mb-6">About Us</h1>

      <p className="max-w-3xl text-lg mb-6 leading-relaxed text-center">
        Welcome to Automensor, your trusted partner in smart home and building automation.
        We deliver cutting-edge Wi-Fi based solutions that require no special wiring and provide seamless integration across devices.
      </p>
