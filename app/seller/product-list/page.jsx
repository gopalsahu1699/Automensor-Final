        ...
        {products.map((product) => {
          ...
          return (
            <div key={product.$id} className="border p-4 rounded shadow-sm">
              {imageIds.length > 0 && (
                <img
                  src={`https://fra.cloud.appwrite.io/v1/storage/buckets/${BUCKET_ID}/files/${imageIds[0]}/view?project=${PROJECT_ID}`}
                  alt={product.name}
              ...
              <p className="mt-2">₹{product.price} <span className="text-sm text-red-500">({product.offerPrice})</span></p>
