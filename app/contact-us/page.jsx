          ...
          >
            {contactInfo.map((info, index) => {
              ...
              return (
                ...
                >
                  <div className={`w-14 h-14 rounded-full ${info.bgColor} flex items-center justify-center mb-4`}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-white shadow-xl">
                <h3 className="text-2xl font-bold mb-6">Why Choose Automensor?</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <div className="bg-orange-50 rounded-xl p-4 border border-orange-100">
                  <p className="text-sm font-semibold text-orange-800 mb-1">Emergency Support</p>
              ...
              <div className="bg-green-50 rounded-2xl p-8 border border-green-100">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600 mt-2">Join hundreds of satisfied homeowners</p>
                </div>
              </div>
            </motion.div>
          </div>
