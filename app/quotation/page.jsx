  ...
  return (
    ...
    >
      ...
      <p className="text-center text-lg text-gray-700 mb-10">
        Unlock the true potential of your smart home with a customized quote based on your home size, number of rooms, and preferred smart devices. Start transforming your living space today!
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            <label htmlFor="homeSize" className="block text-gray-800 font-semibold mb-1">
              Home Size (sq ft)
            </label>
            <input
              type="number"
          ...
          <div>
            <label htmlFor="roomCount" className="block text-gray-800 font-semibold mb-1">
              Number of Rooms
            </label>
            <input
              type="number"
        ...
        {success && <p className="text-green-600 font-semibold">Your request has been saved successfully!</p>}
